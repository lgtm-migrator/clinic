...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='schedule',
            name='phone',
            field=models.CharField(validators=[django.core.validators.RegexValidator(regex='^[0-9]+(-?[0-9]+)+$', code='invalid_phone', message='電話番号を正しく入力してください。')], max_length=15),
        ),
        migrations.AlterField(
            model_name='store',
            name='access',
        ...
        migrations.AlterField(
            model_name='store',
            name='phone',
            field=models.CharField(validators=[django.core.validators.RegexValidator(regex='^[0-9]+(-?[0-9]+)+$', code='invalid_phone', message='電話番号を正しく入力してください。')], max_length=15, verbose_name='電話番号'),
        ),
        migrations.AlterField(
            model_name='store',
            name='region',
        ...
        migrations.AlterField(
            model_name='store',
            name='store_id',
            field=models.CharField(validators=[django.core.validators.MinLengthValidator(1)], max_length=254, verbose_name='Store Code', unique=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='workingday',
            name='type',
            field=models.CharField(max_length=2, choices=[('Mo', '月曜日'), ('Tu', '火曜日'), ('We', '水曜日'), ('Th', '木曜日'), ('Fr', '金曜日'), ('Sa', '土曜日'), ('Su', '日曜日'), ('Ho', '祝祭日')], verbose_name='営業時間帯'),
        ),
    ]
