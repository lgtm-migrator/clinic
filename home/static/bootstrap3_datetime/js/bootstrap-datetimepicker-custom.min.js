    ...
    DateTimePicker = function (element, options) {
        ...
        change = function (e) {
            ...
            if (newDate.isValid() && !isInDisableDates(newDate) && isInEnableDates(newDate)) {
                ...
                // HACK: for delete inline django form
                // NOTE: Please not change model name, it's will not working!!
                if (picker.component && picker.component.context) {
                    var line_number = picker.component.context;
                    var id_name = $(line_number).attr('id') || '';

                    if (id_name) {
                        var deleted_id = id_name.replace('date_picker','DELETE');
                        $('#' + deleted_id).attr('checked', 'checked');
                    }
                }
